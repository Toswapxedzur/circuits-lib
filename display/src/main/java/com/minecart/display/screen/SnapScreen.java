...
public final class SnapScreen extends ScreenAdapter {
    ...
    private com.minecart.display.snap.InputScript.Host scriptHost; // = controller.harness (physical mode)
    ...
    private void buildScene() {
        ...
        if (physical) {
            ...
            controller = new SnapEditorController(physWorld, physEditor, flyCam, camera, deckHud,
                    ...
                    () -> connection != null && connection.isConnected(), on -> fixedCam = on);
            if (designWorld) {
            ...
            scriptHost = controller.harness; // the physical editor's harness / live-console adapter
